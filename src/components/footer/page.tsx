  ...
  return (
    <div className="relative bg-white dark:bg-slate-950">
      ...
      <div className="absolute -z-10 h-full w-full">
        {" "}
        <div className="absolute bottom-auto left-auto right-0 top-0 h-[100px] w-[100px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(173,109,244,0.5)] opacity-50 blur-[80px]"></div>{" "}
      </div>
